...
We first make embeddings for every law in the dataset (after lemmalizing it). After this, we search 50 closest embeddings to the embedding of the query. Then we return 5 closest laws with at most 2 being from the same class (classes are predetermined in the dataset).
